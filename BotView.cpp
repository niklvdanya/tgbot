...
void BotView::createButton(const Education* entity, TgBot::InlineKeyboardMarkup::Ptr& keyboard,const std::string& prefix, const std::string& postfix) 
{
...
void BotView::sendLevelOptions(const TgBot::Chat::Ptr& chat, const std::vector<Level>& levels, const std::string& facultyAlias) {
    TgBot::InlineKeyboardMarkup::Ptr keyboard(new TgBot::InlineKeyboardMarkup);
...
void BotView::sendProgramOptions(const TgBot::Chat::Ptr& chat, const std::vector<Program>& programs, const std::string& alias, int levelId) {
    TgBot::InlineKeyboardMarkup::Ptr keyboard(new TgBot::InlineKeyboardMarkup);
...
void BotView::sendProgramYearsOptions(const TgBot::Chat::Ptr& chat, const std::vector<Program>& programsWithYears, const std::string& alias, int levelId, int programId) {
    TgBot::InlineKeyboardMarkup::Ptr keyboard(new TgBot::InlineKeyboardMarkup);
...
void BotView::sendTeacherOptions(const TgBot::Chat::Ptr& chat, const std::string& message) {
